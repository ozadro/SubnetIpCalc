...
app.controller("myCtrl", function($scope){
  ...
  $scope.max = function () {
    ...
    if($scope.oct0 == 192 && $scope.oct1 == 168){

      return "65536";
    }
    if($scope.oct0 == 172 && $scope.oct1 >= 16){
  ...
  $scope.brojuredaja = function () {
    ...
    for(var i = 1; i < 33; i++){
      ...
      donjagranica = Math.pow(2,i-1);
      gornjagranica = Math.pow(2,i+1);


      if($scope.brU > donjagranica && $scope.brU < gornjagranica ){
  ...
  $scope.lasthostbinary = function () {
    ...
    tester[0] = intToBinary(tester[0]);
    tester[1] = intToBinary(tester[1]);
    tester[2] = intToBinary(tester[2]);
    tester[3] = intToBinary(tester[3]);
    return tester.join(".");
  ...
  $scope.Broadcastbinary = function () {
    var subnetBin = "1".repeat($scope.prefix);
    subnetBin += "0".repeat(32 - subnetBin.length);
    subnetBin = subnetBin.insert(8, ".").insert(17, ".").insert(26, ".");
